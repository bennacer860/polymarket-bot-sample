...
def cmd_continuous_15min(markets: list[str], output: str, ws_url: str | None, market_events_output: str) -> int:
...
def main() -> int:
    ...
    if args.command == "continuous-15min":
        return cmd_continuous_15min(args.markets, args.output, args.ws_url, args.market_events_output)
